          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4">
              <div className="text-sm text-grey-300 font-semibold py-1">
                Like this? Star this project on Github!
              </div>
            </div>
            <div className="w-full md:w-8/12 px-4">
              <ul className="flex flex-wrap list-none md:justify-end justify-center">
                <li>
                <a className="github-button" href="https://github.com/nathanjzhao/yourcupid"
                  data-icon="octicon-star" data-size="large" aria-label="Star nathanjzhao/yourcupid on GitHub"
                >
                  Star
                </a>
                </li>
