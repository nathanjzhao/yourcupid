...
export default function Register() {
  ...
  return (
    ...
    <main>
        ...
        <div
            className="absolute top-0 w-full h-full bg-pink-100"
            // style={{
            ...
            <div className="w-full lg:w-4/12 px-4">
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    ...
                    <div className="text-center" >
                        <small>Have an account? <Link href="/login" className="font-bold hover:text-gray-600">Click here!</Link></small>
